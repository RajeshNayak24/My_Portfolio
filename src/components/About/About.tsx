const About = () => {
  return (
    <section id="about" className="w-full py-10 px-6 md:px-10  ">
      <div className="relative flex flex-col md:flex-row items-center gap-12">
        ...
        <div className="flex-1 px-10 md:px-0">
          ...
          <p className="text-gray-300 leading-relaxed text-lg">
            ...
            passionate Full Stack Software Engineer with experience in building
            scalable dashboards, internal tools, and modern web applications.
            <br />
            <br />I specialize in{" "}
            <span className="text-purple-400">
              React, TypeScript, and Node.js
            </span>
            , and I enjoy turning complex problems into clean, efficient
            solutions.
            <br />
            <br />I focus on performance, usability, and writing code that
            scales.
          </p>
